                ...
                <div class="mb-4 col-md-4">
                    ...
                    <div class="card">
                        <div class="text-center card-body">
                            ...
                            <p class="mb-2 grey-text" >{{$offer -> description}}</p>
                            <p class="mb-2 grey-text" id="price">{{$offer -> price}}</p>
                            ...
                            <a id="checkout" href="{{route('offers.checkout',$offer -> price)}}"
                               role="button" class="px-3 btn btn-success waves-effect waves-light"> شراء المنتج
                            </a>
                        </div>
